      ...
      <Link to={`/category/${listing.type}/${listingId}`}>
        <div>
          <div className="flex flex-col items-center relative pt-2 overflow-hidden">
            <img
              src={listing.imgUrls}
              className="rounded-lg  md:w-[380px] h-[250px] w-full hover:scale-105 transition duration-300 ease-in-out object-cover"
              loading="lazy"
            />
            <Moment
              fromNow
              className="bg-red-500/80 text-white py-1 px-2 rounded-md absolute top-5 right-8"
            >
