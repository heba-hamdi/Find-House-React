      ...
      <section className="max-w-7xl mt-6 p-4 mb-6 md:py-4 md:mx-auto ">
        ...
        <div className="w-full flex justify-center">
          <div className="bg-white w-full">
            <h2 className="mx-6 my-3 md:pt-6 font-semibold">
              Profile information
            </h2>
            <div className="m-6 flex flex-col items-center">
              <form className="md:mb-6 md:pb-6 w-full">
                <input
                  ...
                  className={
                    !changeDetails
                      ? "w-full border border-slate-300 p-2 rounded-md mb-3"
                      : "w-full border border-slate-300 p-2 rounded-md mb-3 bg-red-200"
                  }
                ...
                <div className="flex flex-col md:flex-row md:justify-between">
                  <p className="text-xs md:text-sm mt-3 text-gray-400">
                    ...
                    <span
                      className="ml-1 font-semibold text-red-400 hover:text-red-600 cursor-pointer"
                      onClick={changeandsubmit}
                    >
                      {!changeDetails ? "Edit" : "Apply Changes"}
                    </span>
                  </p>
                  <p
                    onClick={logout}
              ...
              <div className="md:m-6 w-full">
                <button
                  type="submit"
                  className="bg-red-500 text-white py-2 w-full rounded-lg hover:bg-red-600 "
                >
                  <Link
                    to="/create-listings"
                  ...
                  >
                    ...
                    <p className="text-lg">Sell/Rent your House</p>{" "}
                  </Link>
                </button>
              </div>
            </div>
