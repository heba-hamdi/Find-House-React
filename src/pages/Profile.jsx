...
const Profile = () => {
    ...
    return (
        <>
        <section className='max-w-7xl m-auto mt-6 pt-4 mb-6'>
            ...
            <div className='bg-white rounded-md flex justify-between'>
                <h2 className='mx-6 py-6'>Profile information</h2>
                <div className='w-3/4 m-6'>
                    <form className='m-6  py-6'>
                        ...
                        <div className='flex justify-between'>
                            <p className='text-sm mt-3 text-gray-400'>Do you want to change your username?
