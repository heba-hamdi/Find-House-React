...
const SignIn = () => {
  ...
  return (
    // Page  Transition
    <motion.section
      className="fixed inset-0 bg-black/50 bg-blur-sm"
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
      exit={{ opacity: 0 }}
    >
        ...
        <div className="grid w-[400px] lg:grid-cols-2 lg:w-[800px] bg-white m-auto text-center font-semibold rounded-md relative">
          ...
          <div className="flex flex-col ">
            ...
            <div className="md:my-3 flex items-center h-full">
              <img
                src="https://images.unsplash.com/photo-1507208773393-40d9fc670acf?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MzR8fGNvbXB1dGVyfGVufDB8MXwwfHw%3D&auto=format&fit=crop&w=500&q=60"
                className="w-11/12 m-auto rounded-3xl p-5 h-[300px] lg:h-full object-cover"
                alt=""
              />
            </div>
          </div>
          <div>
            <button
              className="py-6 w-full bg-gray-100 lg:inline-block hidden"
            ...
            <div className="h-full  flex items-start justify-center mt-3 mr-5">
              <form className="py-6 ml-3 w-full" onSubmit={onFormSubmit}>
                ...
                <div className="relative">
                  <input
                    type="email"
                    className='w-full font-normal border rounded-md  border-gray-200 " p-2 mb-5'
                    placeholder="Email"
                    id="email"
                    value={email}
                  ...
                  {email ? (
                    ...
                    <AiOutlineMail className="absolute bottom-8 right-3 text-xl text-gray-400" />
                  )}
                </div>
                ...
                <div className="relative">
                  <input
                    ...
                    className='w-full font-normal border rounded-md  border-gray-200 " p-2'
                  ...
                  {showPassword ? (
                    <AiOutlineEyeInvisible
                      className="absolute bottom-3 right-3 text-xl text-gray-400 cursor-pointer"
                      onClick={() => {
                ...
                <div className="flex justify-between mt-6">
                  <div>
                    ...
                    <label
                      htmlFor="remember-me"
                      className="font-thin text-sm ml-2"
                    >
                      Remember me
                    </label>
                  </div>
                ...
                <div>
                  <button
                    className="w-full font-normal border border-red-500 rounded-md p-3 text-white bg-red-500 mb-5 hover:bg-white hover:text-red-500 mt-3 transition duration-500"
                    type="submit"
                  >
                ...
                <div className="font-thin text-sm mt-3">
                  ...
                  <Link
                    className=" text-red-500 cursor-pointer hover:text-red-700 transition duration-400 ease-in-out"
                    to="/sign-up"
                  >
                    {" "}
                    Register
