              ...
              <form onSubmit={onSubmit} className="py-6 ml-3 w-full">
                ...
                <div className="relative">
                  ...
                  {name ? (
                    ...
                    <AiOutlineUser className="absolute bottom-8 right-3 text-xl text-gray-400" />
                  )}
                </div>
                ...
                <div className="relative">
                  ...
                  {showPassword ? (
                    <AiOutlineEyeInvisible
                      className="absolute bottom-8 right-3 text-xl text-gray-400 cursor-pointer"
                      onClick={() => {
                ...
                <div className="float-left">
                  ...
                  <label
                    htmlFor="remember-me"
                    className="font-thin text-xs ml-2 text-gray-400 "
                  >
                ...
                <div>
                  <button
                    className="w-full font-normal border border-red-500 rounded-md p-3 text-white bg-red-500 mb-3 hover:bg-white hover:text-red-500 mt-3 transition duration-500"
                    id="facebook"
                    type="submit"
                  >
